...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('maintenances', function (Blueprint $table) {
            ...
            if (! Schema::hasColumn('maintenances', 'advisual_requisition_id')) {
                $table->unsignedBigInteger('advisual_requisition_id')->nullable();
            }
            if (! Schema::hasColumn('maintenances', 'advisual_synced_at')) {
                $table->datetime('advisual_synced_at')->nullable();
            }
